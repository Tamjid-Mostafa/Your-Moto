...
const ReportedItems = () => {
  ...
  /* Product Load */
  const url = `https://yourmoto-server-tamjid-mostafa.vercel.app/reportedItems`;
  ...
  const handleDeleteProduct = (product) => {
    fetch(`https://yourmoto-server-tamjid-mostafa.vercel.app/deleteReportedItem/${product?._id}`, {
      method: "DELETE",
      headers: {
        authorization: `bearer ${localStorage.getItem("yourMoto_Token")}`,
      },
