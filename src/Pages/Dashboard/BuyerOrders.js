                  ...
                  {bookedItem?.advertise !== true && (
                    <Link to={`/dashboard/payment/${bookedItem?._id}`}>
                      <button
                        ...
                        disabled={bookedItem.paid}
                        type="button"
                        className={`${!bookedItem.paid  ? "text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80" : "text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"} font-medium rounded-lg text-sm px-2 py-0.5`}
                      >
                        {!bookedItem.paid  ? "Pay" : "Paid"}
                      </button>
                    </Link>
                  )}
                </td>
